    ...
    return(
        ...
        <div className="s:pb-16">
            <div className="w-full flex flex-col justify-center items-center">
                ...
                <p className="font-Gotham text-2xl x:text-3xl s:text-5xl mt-4 mb-6 font-bold">FAQ</p>
            </div>

            <div dir="rtl" className="py-8 pt-8 s:pt-24 px-8 x:px-16 flex flex-row items-center m:px-64">
                ...
                <div className="bg-ocean w-full x:w-[352px] h-auto x:h-20 flex items-center rounded-3xl s:ps-8 text-[#EEEEEE] text-sm z-20 mt-2 p-4">
                    .다룰 줄 아는 악기가 없지만 깔루아에 들어가고 싶어요<br/>
                    ?깔루아에 지원해도 될까요
                </div>
            </div>

            <div dir="ltr" className="px-8 x:px-20 flex flex-row items-center m:px-64">
                ...
                <div className="bg-[#EEEEEE] w-full x:w-[512px] h-auto x:h-28 flex items-center rounded-3xl s:ps-6 text-sm z-20 p-4">
            ...
            <div dir="rtl" className="px-8 x:px-16 s:pt-8 flex flex-row items-center m:px-64">
                ...
                <div className="bg-ocean w-full x:w-[380px] s:w-[476px] h-auto s:h-12 flex items-center rounded-3xl s:ps-8 mt-12 text-[#EEEEEE] text-sm z-20 p-4">
            ...
            <div dir="ltr" className="px-8 x:px-20 flex flex-row items-center m:px-64">
                ...
                <div className="bg-[#EEEEEE] w-full x:w-[360px] h-auto x:h-20 flex items-center rounded-3xl s:ps-6 mt-8 s:mt-4 text-sm z-20 p-4">
                    네! 저도 자율전공이랍니다.<br/>
