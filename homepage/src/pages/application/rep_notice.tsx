    ...
    return (
        ...
        <div className="w-full h-auto py-36 flex flex-col justify-center items-center">
            ...
            <div className="z-10 w-full flex flex-col justify-center items-center">
                ...
                <a className="flex justify-center items-center h-[64px] w-[260px] x:w-1/2 rounded-[300px] bg-ocean mt-14 text-xl x:text-2xl font-semibold text-[#FFFFFF]" href="/application/apply">
                    KAHLUA 23기 지원하기
                </a>
