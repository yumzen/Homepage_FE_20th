        ...
        script.onload = () => {
            window.kakao.maps.load(() => {
                ...
                */
                ...
                const map1 = new window.kakao.maps.Map(container1, { ...options, level: 3 });
                const map2 = new window.kakao.maps.Map(container2, { ...options, level: 2 });
    
                const markerPosition = new window.kakao.maps.LatLng(37.55099593968109, 126.92401144435387);
                    ...
                    <div className=" flex flex-row w-[100%] lg:w-[1024px] justify-center items-center content-center">
                        ...
                        <div className="w-[50vw] h-[200px] sm:h-[300px] md:h-[300px] lg:w-[720px] lg:h-[460px] ml-[11px] lg:ml-[23px] mt-0 top-0 flex-shrink-0">
                            ...
                            <div className="flex flex-row left-0 whitespace-nowrap">
                                <div className="font-['pretendard'] w-[32vw] sm:w-[150px] md:w-[280px] h-[20px] lg:mt-[8px] lg:w-[350px] lg:h-[42px] flex flex-shrink-0 text-black font-[700] text-[14px] sm:text-[16px] md:text-[28px] leading-[40px] whitespace-nowrap">{data[0].title}</div>
