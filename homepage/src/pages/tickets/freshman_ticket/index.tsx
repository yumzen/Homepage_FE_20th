...
export default function freshman_ticket(){
    ...
    return (
        <div className="w-[100%] h-[1900px] lg:h-[1800px] z-60">
            <Background>
                ...
                <div className="flex flex-col items-center mx-[12.5vw] text-center mt-[24px] sm:mt-[40px]">
                    ...
                    <div className="mt-[16px] font-[700] text-[20px] sm:text-[32px] leading-[42px] whitespace-nowrap flex flex-row">
                        <div className="text-[#281CFF]">신입생 티켓</div>
                        <span>&nbsp;예매하기</span>
                    </div>
                    <div className="mt-[20px] sm:mt-[32px] font-[500] text-[12px] sm:text-[14px] leading-[21px]">
                        <div>깔루아 2023 9월 정기공연</div>
                        <div>2023.09.01 오후 6시</div>
                    </div>
                </div>
                <div className="mt-[64px] flex flex-col mx-auto w-[100%]">
                    ...
                    <div className="ml-[0.5vw] ">
                        ...
                        <div className="mt-[16px] relative flex flex-row justify-between sm:justify-normal">
                            <div className="flex flex-row">
                                <div className="w-[68px] sm:w-[120px] h-[76px] flex flex-col justify-center flex-shrink-0 text-[16px] sm:text-[24px] font-[700] text-[#939393]">5000원</div>
                                <div className="flex flex-col justify-center flex-shrink-0 text-[16px] sm:text-[24px] leading-[28px] font-[700] text-[#281CFF]">0원</div>
                            </div>
                            <div className="absolute left-0 top-2 sm:top-7">
                                <Image src="/assets/images/tickets/Arrow.svg" alt="arrow" width={100} height={100} className="w-[60px] h-[60px] sm:w-[auto] sm:h-[auto]"/>
                            </div>
                            <div className="bg-[white] w-[80px] sm:w-[110px] h-[26px] sm:h-[35px] mt-[20px] ml-[5vw] flex flex-shrink-0 border border-solid border-[#D9D9D9] rounded-[10px] items-center justify-center">
                                <div className="flex gap-2 sm:gap-4 text-[20px] sm:text-[26px] font-[700]">
                                    <button className="flex h-[25.9px] sm:h-[35px] my-auto pr-[8px] text-center items-center justify-center border-r border-[#D9D9D9]" onClick={handleDecrement}>-</button>
                                    <p >{count}</p>
                                    <button className="flex h-[25.9px] sm:h-[35px] my-auto pl-[8px] text-center items-center justify-center border-l border-[#D9D9D9]" onClick={handleIncrement}>+</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mx-auto ml-[0.5vw]">
                        <div className=" flex lg:flex-row flex-col ">
                            <div className="mt-[30px] w-[140px] h-[29px] font-[700] pt-[8px] text-[16px] sm:text-[20px] leading-[24px]">예매자 정보 입력</div>
                            <div className="w-[80vw] h-[50px] lg:w-[60vw] text-[10px] sm:text-[14px] text-[#464646] lg:ml-[2.5vw] ml-[0.5vw] flex flex-col lg:mt-[16px] mt-[24px] ">
                        ...
                        <div className="mt-[18px] flex flex-col md:flex-row mx-auto">
                            ...
                            <div className="input-with-placeholder relative lg:w-[21vw] md:w-[18vw] w-[60vw] ml-[1vw] h-[32px] sm:h-[43px] flex-shrink-0 border bg-[white] border-[#6A6A6A] border-solid rounded-[10px] px-2">
                                <input value={buyer} type="text" placeholder="" onChange={(e) => setBuyer(e.target.value)}/>
                            </div>
                            <label className="ml-[1vw] md:ml-[7.5vw] text-[12px] sm:text-[16px] leading-[26px] font-[500] items-center flex h-[32px] sm:h-[43px] w-[7.5vw] min-w-[55px]">연락처</label>
                            <div className="input-with-placeholder relative lg:w-[24vw] md:w-[18vw] w-[60vw] ml-[1vw] h-[32px] sm:h-[43px] flex-shrink-0 border bg-[white] border-[#6A6A6A] border-solid rounded-[10px] px-2">
                        ...
                        <div className="mt-[20px] flex flex-col md:flex-row">
                            ...
                            <label className="ml-[1vw] md:ml-[7.5vw] text-[12px] sm:text-[16px] leading-[26px] font-[500] items-center flex h-[32px] sm:h-[43px] w-[7.5vw] min-w-[55px]">학번</label>
                            <div className="input-with-placeholder relative lg:w-[24vw] md:w-[18vw] w-[60vw] ml-[1vw] h-[32px] sm:h-[43px] flex-shrink-0 border bg-[white] border-[#6A6A6A] border-solid rounded-[10px] px-2">
                    ...
                    <div className="ml-[0.5vw]">
                        <div className="mt-[32px] flex lg:flex-row flex-col">
                            ...
                            <div className="whitespace-pre-wrap w-[47.5vw] h-[26px] lg:ml-[2.5vw] ml-[0.5vw] lg:mt-[5px] mt-[15px] text-[10px] sm:text-[14px] font-[500] leading-[21px] text-[#464646] flex-shrink-0 flex flex-col lg:flex-row">
                    ...
                    <div className="ml-[0.5vw]">
                        <div className="flex flex-col lg:flex-row">
                            <div className="w-[200px] h-[29px] mt-[32px] font-[700] text-[16px] sm:text-[20px] leading-[30px]">신입생 뒷풀이 참여 여부</div>
                        ...
                        <div className="mt-[20px] text-[12px] sm:text-[20px] flex flex-row">
                    ...
                    <div className="ml-[0.5vw]">
                        <div className="mt-[20px] flex flex-row">
                            <div className="w-[247px] h-[29px] pt-[32px] font-[700] text-[16px] sm:text-[20px] leading-[28px]">유의사항 및 취소규정</div>
                        </div>
                        <ol className="list-decimal ml-[24px] font-[500] text-[10px] sm:text-[14px] lg:text-[16px] mt-[44px] leading-[26px]">
