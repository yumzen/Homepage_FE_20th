    ...
    if (isFormComplete === true) {
      try {
        ...
        const response = await axios.post(
          `${baseUrl}/tickets/freshman_ticket/`,
          formData
        );
              ...
              <div className="mt-[12px] sm:mt-[16px] relative flex flex-row justify-between sm:justify-normal">
                ...
                <div className="bg-[white] w-[76px] sm:w-[110px] h-[26px] sm:h-[35px] ml-[5vw] sm:mt-[20px] flex flex-shrink-0 border border-solid border-[#D9D9D9] rounded-[10px] items-center justify-center mr-[5vw] sm:mr-0">
                  <div className="flex gap-2 sm:gap-4 text-[20px] sm:text-[26px] font-[700]">
                    <button
                      className="flex h-[25.9px] sm:h-[35px] my-auto ml-[2px] pr-[7px] sm:ml-[4px] sm:pr-[9px] text-center items-center justify-center border-r text-[#939393] border-[#D9D9D9]"
                    ...
                    <p>{count}</p>
                    <button
                      className="flex h-[25.9px] sm:h-[35px] my-auto pl-[6px] sm:pl-[8px] text-center items-center justify-center border-l text-[#939393] border-[#D9D9D9]"
