...
const freshman_delete = () => {
    ...
    return  (
        ...
        <div className="font-['pretendard'] mx-[12.5vw] flex items-center flex-col mb-[84px] ">
                <div className="flex flex-col items-center mx-[12.5vw] text-center content-center mt-[40px] leading-normal">
                ...
                {reservation_id && (
                    <div className="mt-[12px] sm:mt-[48px] mx-auto items-center content-center flex flex-col ">
                        ...
                        <div className="flex mt-[16px] mx-auto sm:ml-[4px] flex-col w-[75vw] sm:w-[300px] md:w-[516px]">
                            ...
                            <input type="text" value={input_sid} onChange={(e) => set_sid(e.target.value)} placeholder="학번을 입력해 주세요." className="mt-[10px] bg-[#FFF] border  border-[#4A4A4A] rounded-[3px] text-[10px] sm:text-[14px] outline-[#000] w-[150px] h-[28px] sm:w-[180px] sm:h-[36px] text-[black] px-[8px]" onKeyDown={handleInputKeyPress}/>
                            {!validSid && <p className="text-[#F00] text-[10px] font-[400] leading-[19px] align-center mt-[2px]">⚠️ 잘못된 입력 정보입니다.</p>}
                        </div>
                        <div className="w-[75vw] sm:w-[400px] md:w-[514px] h-[36px] sm:h-[48px] mt-[20px] sm:mt-[48px] mx-auto flex items-center">
